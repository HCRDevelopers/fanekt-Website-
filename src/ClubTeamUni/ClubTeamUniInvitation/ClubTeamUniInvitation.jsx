...
function ClubTeamUniInvitation() {
  ...
  const invitationsList = [
    ...
    { id: 9, email: 'local.fan@email.com', name: 'Local Fan', status: 'joined', role: 'Fan', date: '2024-01-07' },
    { id: 10, email: 'youth.coach@email.com', name: 'Youth Coach', status: 'joined', role: 'Athlete', date: '2024-01-06' }
  ];
  ...
  const handleDownloadQR = () => {
    if (qrRef.current && referralCode) {
      ...
      link.download = 'fanekt-club-invitation-qr.png';
        ...
        <div className="space-y-6">
          <div>
            <label className="block text-white font-medium mb-2">
              Recipient Email <span className="text-red-400">*</span>2
            </label>
            <input
              type="email"
              name="recipientEmail"
...
export default ClubTeamUniInvitation;
