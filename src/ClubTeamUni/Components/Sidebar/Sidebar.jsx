...
const Sidebar = () => {
  ...
  // 🔹 Page Headings
  const pageConfigs = {
    "/team/dashboard": { heading: "My Account" },
    "/team/invite": { heading: "Invite" },
    "/team/portal": { heading: "Open Portal" },
    "/team/scan": { heading: "Scan" },
    "/team/store": { heading: "Store" },
    "/team/rankings": { heading: "Rankings" },
  };
                  ...
                  <div className="flex gap-2 items-center">
                    ...
                    <div>
                      <p className="text-white font-medium text-[17px]">
                        {userProfile.name || 'Team'}
                      </p>
                      <p className="text-[#ffffff85] font-medium text-[12px]">
                        {userProfile.email || 'team@example.com'}
                      </p>
                    </div>
                  </div>
                  <img
