            ...
            if (res?.data?.status && res.data.data) {
                ...
                setFormData((prev) => ({
                    ...
                    gender: data.gender
                        ...
                        : prev.gender,
                    fan_of: data.fan_of || prev.fan_of,
                    dream_of: data.dream_of || prev.dream_of,
                }));
            } else {
                    ...
                    <div className="space-y-2">
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-2 gap-2 mt-2">
                                <div
                                    onClick={() => handleGenderSelect("Male")}
                                    className={`flex items-center justify-center gap-2 px-2 py-3 text-center rounded-xl border cursor-pointer transition-all duration-200 ${formData.gender === "Male"
                                            ? "bg-[#155BF2] text-white border-[#155BF2]"
                                            : "bg-transparent border-white/10 text-gray-400 hover:border-white/30"
                                        }`}
                                >
                                ...
                                <div
                                    onClick={() => handleGenderSelect("Female")}
                                    className={`flex items-center justify-center gap-2 px-2 py-3 text-center rounded-xl border cursor-pointer transition-all duration-200 ${formData.gender === "Female"
                                            ? "bg-[#FE4B5E] text-white border-[#FE4B5E]"
                                            : "bg-transparent border-white/10 text-gray-400 hover:border-white/30"
                                        }`}
                                >
