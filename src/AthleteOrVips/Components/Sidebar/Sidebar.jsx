...
const Sidebar = () => {
  ...
  // 🔹 Page Headings
  const pageConfigs = {
    "/athlete/dashboard": { heading: "My Account" },
    "/athlete/invite": { heading: "Invite" },
    "/athlete/portal": { heading: "Open Portal" },
    "/athlete/scan": { heading: "Scan" },
    "/athlete/store": { heading: "Store" },
    "/athlete/rankings": { heading: "Rankings" },
  };
