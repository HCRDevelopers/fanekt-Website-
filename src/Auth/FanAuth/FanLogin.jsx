  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (data?.status && data?.data?.token) {
        ...
        let redirectPath = '/fan/dashboard'; // default fallback

        if (userType === 'fan') {
          redirectPath = '/fan/dashboard';
        } else if (['club', 'uni', 'team'].includes(userType)) {
          redirectPath = '/team/dashboard';
        } else if (['sponsor', 'partner'].includes(userType)) {
          redirectPath = '/sponsor/dashboard';
        } else if (['athlete', 'vip'].includes(userType)) {
