...
import { sponsorSignup } from "../../API/apiService";

// Custom Dropdown Component (not needed for sponsor form, but keeping for consistency)
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            <button
                ...
                className="text-white placeholder:text-[16px] placeholder:font-[400] placeholder:text-gray-300 border-2 border-t-0 border-l-0 border-r-0 border-[#e6e7e9] py-3 pl-1 w-full outline-0 bg-[linear-gradient(to_bottom_right,_#2d2e58,_#2d2e58)] text-left flex items-center justify-between"
            >
  ...
  const handleImageChange = (e) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!formData.legalRepresentative.trim()) {
            toast.error('Legal representative name is required');
            return;
        }
        ...
        formDataToSend.append("full_name", formData.companyLegalName.trim());
        formDataToSend.append("brand_name", formData.brandName.trim());
        ...
        try {
            const response = await sponsorSignup(formDataToSend);
    ...
    return (
        ...
        >
            ...
            {/* Right Side Form */}
            <div className="w-full lg:w-[50%] lg:mb-20 lg:mt-0 lg:py-0 py-10 flex flex-col items-center justify-center px-3 md:px-6 h-full overflow-y-auto scrollbar-hide">
                <div className="lg:h-[80vh] h-full w-full">
                    ...
                    <div className="text-center mb-6">
                        ...
                        >
                            Join FANEKT as a Sponsor/Partner
                        </motion.h1>
                        <motion.p
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                        ...
                        >
                            Create your company portal access as its legal representative. You will be able to fund targeted campaigns, distribute FAN€KT PAY to fans and share revenues with verified Teams, Clubs and Athletes. Verification (KYC) unlocks full financial features and reporting.
                        </motion.p>
                    </div>
