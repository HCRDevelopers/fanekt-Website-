...
const Sidebar = () => {
  ...
  const sections = [
    {
      items: [
        ...
        {
          path: "/fanManagement",
          label: "Fan Management",
          icon: Users,
          activeIcon: Users
        },
        {
          path: "/clu-uni-team-Management",
          label: "Club / Uni / Team",
          icon: Trophy,
          activeIcon: Trophy
        },
        {
          path: "/athlete-vip-Management",
          label: "Athlete & Vips",
          icon: Star,
          activeIcon: Star
        },
        {
          path: "/sponsor-partner-Management",
        ...
        {
          path: "/dashboard/licensee-management",
  ...
  const pageConfigs = {
    ...
    "/programTag": { heading: "Program Tag" },
    "/ProgrammedSuccess": { heading: "Program Tag" },
    "/tagManagement": { heading: "Tag Management" },
    "/fanManagement": { heading: "Fan Management" },
    "/broadCasts": { heading: "BroadCasts" },
  };
              ...
              <div className="w-full flex justify-center">
                <div className="flex justify-between items-center w-[240px] my-5 pb-5  border-b-[3px] border-[#ffffff86]">
                  <div className="flex gap-2 items-center">
                    <img src={Admin} className="w-[50px] rounded-full" alt="" />
                    <div>
